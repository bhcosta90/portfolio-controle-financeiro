...
namespace Tests\Feature\src\Application\Charge\Modules\Receive\Services;
...
class PaymentServiceTest extends TestCase
{
    ...
    public function testHandle()
    {
        $uc = new PaymentService(
            repository: app(ChargeReceiveRepository::class),
            transaction: app(TransactionInterface::class),
            relationship: app(CustomerRepository::class),
