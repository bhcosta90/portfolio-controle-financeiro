...
var _require = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"),
    axios = _require["default"]; // window.Vue = require('vue').default;
...
if ($("#account_resume").length) {
  ...
  axios.get("/charge/total?type=".concat(type)).then(function (json) {
    ...
    var classAccount = "text-danger";
    var classCalculate = "text-danger";
