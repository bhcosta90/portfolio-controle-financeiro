    ...
    <div class='card-body'>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <h4 style='text-decoration:underline;cursor:pointer' onclick="$(this).parents('.card-body').find('.value').val($(this).data('value'))" class='text-info' data-value="{{ $model->value - $model->pay }}">
