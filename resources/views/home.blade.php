    ...
    <div id='home'>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6 request"
                 data-route="{{ route('admin.charge.payment.due.date', ['month' => request('month')]) }}">
            ...
            <div class="col-lg-3 col-6 request"
                 data-route="{{ route('admin.charge.receive.due.date', ['month' => request('month')]) }}">
        ...
        <div class='row'>
            ...
            <div class="col-4 request"
                 data-route="{{ route('admin.charge.payment.value.month', ['month' => request('month')]) }}">
            ...
            <div class="col-4 request"
                 data-route="{{ route('admin.charge.receive.value.month', ['month' => request('month')]) }}">
                <div class="small-box box bg-secondary" data-success="bg-success" data-danger="bg-danger">
                    <div class="inner">
                        <h3 class='total_real' data-prefix='R$'>...</h3>
