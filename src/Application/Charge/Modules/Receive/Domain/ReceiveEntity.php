...
class ReceiveEntity extends EntityAbstract implements ChargePayInterface
{
    ...
    public static function create(
        ...
        return new self(
            ...
            customer: new EntityObject($customer, CompanyEntity::class),
    ...
    public function update(
        ...
        $this->customer = new EntityObject($customer, CompanyEntity::class);
    ...
    public function pay(float $value): float
    {
        if ($value + $this->pay->value > $this->value->value) {
            throw new ChargeException('The receive is greater than the amount of the account payable');
        }
    ...
    public function cancel(float $value): self
    {
        ...
        if ($calc < 0) {
            throw new ChargeException('This receive cannot be canceled as it leaves the charge amount less than 0');
        }
