...
use Core\Application\Relationship\Modules\Customer\UseCases;
...
{
    private $title = [
        'store' => 'Cliente cadastrado com sucesso',
        'update' => 'Cliente editado com sucesso',
        'destroy' => 'Cliente deletada com sucesso'
    ];

    private $route = 'admin.relationship.customer';
