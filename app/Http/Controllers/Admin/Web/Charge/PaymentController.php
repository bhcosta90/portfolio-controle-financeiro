...
use Core\Financial\Charge\Modules\Payment\UseCases\{
    CreateUseCase,
    ListUseCase,
    FindUseCase,
    UpdateUseCase,
...
use Core\Financial\Charge\Modules\Payment\UseCases\DTO\{Create\CreateInput, Update\UpdateInput, Pay\PayInput};
...
class PaymentController extends Controller
{
    ...
    public function payShow(FormSupport $formSupport, FindUseCase $findUseCase, string $id)
    {
        $form = $formSupport
            ->button(__('Editar'))
            ->run(PayForm::class, route('admin.charge.payment.pay.store', $id));
